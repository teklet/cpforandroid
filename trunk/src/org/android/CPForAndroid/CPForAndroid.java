...
public class CPForAndroid extends Activity implements OnItemClickListener{
    ...
    private RSSFeed getFeed(String urlToRssFeed)
    {
    	try
    	{
           ...
           {
        	   sb.append(PrepAndEncodeLine(line));
        	   //DEBUGGING
           ...
           ByteArrayInputStream baIS = new ByteArrayInputStream(sb.toString().getBytes());//MAYBE BREAK HERE IF SITE IS IN MAINTENANCE OR BAD FEED?
