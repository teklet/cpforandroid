...
public class DbDataLayer 
{
	    ...
	    {
	    	for (RSSItem Mainitem : CPForAndroid.Mainfeed.getAllItems())
	    	{
	    		AddRSSFeedAsRead(Mainitem.getTitle(), Mainitem.getLink(), Mainitem.getPubDate());
			}
	    	
	    	for (RSSItem Loungitem : CPForAndroid.Loungefeed.getAllItems())
	    	{
	    		AddRSSFeedAsRead(Loungitem.getTitle(), Loungitem.getLink(), Loungitem.getPubDate());
			}
